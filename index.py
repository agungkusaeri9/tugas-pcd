...
def submit():
    ...
    # ... (Sisipkan kode deteksi kendaraan Anda di sini)
            ...
            if ret==True:
                    ...
                    if area>300:
                        ...
                        if cy in range(up_limit,down_limit):
                            ...
                            if new==True:
                                ...
                                cars.append(p)
                                pid += 1  # Fix: pid += 1 instead of pid+1
                        img=cv2.rectangle(frame,(x,y),(x+w,y+h),(0,255,0),2)
                ...
                for i in cars:
                    ...
                    if line_down+20<= i.getY() <= line_up-20:
                        a = (h + (.74*w)- 100)
                        # ... (Tambahkan logika atau operasi lainnya sesuai kebutuhan)
    ...
    # Menampilkan informasi dalam jendela baru sebelum menutup aplikasi
    info_window = tk.Tk()
    info_window.title("Informasi Video")

    # Tampilkan informasi dalam label
    info_label = tk.Label(info_window, text=f"Nama Video: {video_name}\nDurasi Video: {video_duration} detik\nJumlah Up: {cnt_up}\nJumlah Down: {cnt_down}")
    info_label.pack(pady=20)

    # Menjalankan jendela informasi
